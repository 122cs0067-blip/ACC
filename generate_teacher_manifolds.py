...
for i-ppDRE drift detection. These manifolds represent the "territory of truth"
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '02_SRC')))
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="01_DATA/models/teacher_manifolds",
